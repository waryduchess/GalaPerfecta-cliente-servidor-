...
$servicioController = new inicioControladorServicio();
$servicioController->handleRequest();
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="loading-container">
    <?php if ($servicioController->insertada): ?>
...
<script>
    ...
    <?php else: ?>
        setTimeout(function() {
            window.location.href = "index.php?c=crearServicios";
        }, 5000);
    <?php endif; ?>
</script>
</body>
