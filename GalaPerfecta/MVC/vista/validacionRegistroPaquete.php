...
$paqueteController = new inicioControladorPaquete();
$paqueteController->handleRequest();
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="loading-container">
    <?php if ($paqueteController->insertada): ?>
...
<script>
    ...
    <?php else: ?>
        setTimeout(function() {
            window.location.href = "index.php?c=crearPaquete";
        }, 5000);
    <?php endif; ?>
</script>
</body>
